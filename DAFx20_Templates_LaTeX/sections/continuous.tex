...
and make $c$ dynamic (or time-varying), i.e., $c = c(t)$, which will prove easier to work with in the following section. This fact can more easily be seen if Eq. \eqref{eq:1dwave} is scaled or non-dimensionalised as in \cite{bilbao2009} where scaled domain  $x' = x/L\  \Rightarrow \ x'\in[0, 1]$ and $\gamma = c/L$. To retain generality, however, we continue with the dimensional case.
