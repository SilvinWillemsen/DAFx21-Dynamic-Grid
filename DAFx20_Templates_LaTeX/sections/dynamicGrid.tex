...
\end{cases}
\end{equation}
\MDcomment[looks like Fc needs a minus in the second equation ...] \SWcomment[there is already a minus before $J_w$ that inverts its sign. That should be fine right?] \MDcomment[Cool!]Furthermore, using centred temporal averaging and first-order difference operators
