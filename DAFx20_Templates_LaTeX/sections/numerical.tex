...
Using FDTD methods, the continuous 1D wave equation in Eq. \eqref{eq:1dwave} can be discretised into points in space and time. The spatial variable can be discretised using $x_l = lh$ %(read: $x$ at spatial index $l$) 
...
which can be implemented in software. %This update can then be implemented in software, such as {\tt MATLAB} or {\tt C++}. 
Here,
